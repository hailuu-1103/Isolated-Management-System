...
<div class="col-10 content">
    <div class="content-label">
        ...
        <span class="content-label__info"><i class="fas fa-home"></i> Hệ thống > Báo cáo sức khỏe > Tạo báo cáo mới</span>
        <div class="spacer2"></div>
    </div>

    <div class="form-container">
        <h3>Báo cáo sức khỏe chi tiết</h3>
        <br><br><input class="form-control" name="reportId" type="text" value="${report.getId_report()}" style="display: none">
