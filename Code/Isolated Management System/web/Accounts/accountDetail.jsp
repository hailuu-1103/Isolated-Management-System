...
<div class=" user-container ">
    <div class="menu">
        <ul>
            ...
            <li class="menu-li"><a href="<%=request.getContextPath()%>/Accounts/accountDetail.jsp" class="menu-item"><i class="far fa-user-circle"></i> Tài khoản của tôi</a></li>
            <li class="menu-li"><a href="<%=request.getContextPath()%>/Accounts/accountDetail.jsp" class="menu-item depend"> Hồ sơ</a></li>
            <li class="menu-li"><a href="<%=request.getContextPath()%>/Accounts/ChangePassword.jsp" class="menu-item depend"> Đổi mật khẩu</a></li>
            <li class="menu-li"><a href="<%=request.getContextPath()%>/Accounts/checkAccount.jsp" class="menu-item active"><i class="fas fa-user-check"></i> Xác minh thuộc khu cách ly</a></li>
    ...
    <div class="menu-detail">
        ...
        <div class="menu-list">
            <form action="update" method="POST" id="form-user" class="form-user">
                ...
                <div class="form-group">
                    ...
                    <input id="ten_nguoi_dung" class="form-control" name="fullname" type="text" value="${userLogin.getPatient().getPatientName()}">
                    <span class="form-message"></span>
                </div>
